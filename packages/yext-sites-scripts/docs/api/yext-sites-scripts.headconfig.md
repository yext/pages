...
| -------------------------------------------------------- | --------- | ---------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [charset?](./yext-sites-scripts.headconfig.charset.md)   |           | string                                         | <i>(Optional)</i> Declares the document's encoding. Will default to 'UTF-8' if omitted.                                                                             |
| [lang?](./yext-sites-scripts.headconfig.lang.md)         |           | string                                         | <i>(Optional)</i> Lang of the page. Will be set to the document's locale if omitted.                                                                                |
...
| [viewport?](./yext-sites-scripts.headconfig.viewport.md) |           | string                                         | <i>(Optional)</i> Declares the size and shape of the document's viewport. Will default to 'width=device-width, initial-scale=1' if omitted.                         |
