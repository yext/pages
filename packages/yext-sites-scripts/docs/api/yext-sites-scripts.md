...
|  [GetRedirects](./yext-sites-scripts.getredirects.md) | The type definiton for the template's getRedirects function. |
...
|  [TransformProps](./yext-sites-scripts.transformprops.md) | The type definition for the template's transformProps function. Can be used to alter and/or augement the props (which include the data document) passed into the template at render time. |
