...
| [getRedirects?](./yext-sites-scripts.templatemodule.getredirects.md)     | [GetRedirects](./yext-sites-scripts.getredirects.md)<!-- -->&lt;T&gt;     | <i>(Optional)</i> The exported, optional, function which returns a list of redirects |
