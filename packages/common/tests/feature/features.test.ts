import { convertTemplateConfigFeatureConfig, convertTemplateConfigToFeaturesConfig, FeatureConfig, FeaturesConfig } from "../../src/feature/features";
...
describe("features - convertTemplateConfigToFeaturesConfig", () => {
    it("returns a FeaturesConfig with no StreamConfig if no stream is defined", async () => {
        ...
        const featuresConfig = convertTemplateConfigToFeaturesConfig(templateConfig);
...
describe("features - convertTemplateConfigFeatureConfig", () => {
    it("validates that both streamId and stream are not defined", async () => {
      ...
      const featureConfigFunc = () => convertTemplateConfigFeatureConfig(templateConfig);
  
      expect(featureConfigFunc).toThrowError(`TemplateConfig must not define both a "streamId" and a "stream".`);
    });
