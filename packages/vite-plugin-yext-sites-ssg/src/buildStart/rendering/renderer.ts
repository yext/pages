 ...
 * form  plugin/mod.ts. This function loads the template module for the provided feature and
 * executes either its render function or its renders its default-exported React component to
