...
describe("getYextUrlForPartition", () => {
  it("gets the Yext url for a US prod account", () => {
  ...
  it("gets the Yext url for a US sandbox account", () => {
  ...
  it("gets the Yext url for an EU qa account", () => {
    const url = getYextUrlForPartition("qa", "EU");
    expect(url).toEqual("app-qa.eu.yext.com");
  });

  it("returns nothing for an invalid partition", () => {
    const url = getYextUrlForPartition("prod", "AS");
    expect(url).toEqual("");
  });

  it("returns nothing for an invalid universe", () => {
